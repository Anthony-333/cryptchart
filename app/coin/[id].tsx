...
export default function CoinDetails() {
  ...
  const currentPrice = selectedPoint ? selectedPoint.value : (chartData[chartData.length - 1]?.value || 98509.75);
      ...
      <View style={styles.holdingsSection}>
        <View style={styles.holdingsHeader}>
          <View style={styles.coinInfo}>
            ...
            <View>
              <Text style={styles.holdingsCoinName}>Bitcoin</Text>
              <Text style={styles.holdingsAmount}>0.00 BTC</Text>
            </View>
          </View>
